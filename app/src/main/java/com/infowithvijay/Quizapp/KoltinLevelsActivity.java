...
//        Level6.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        if (CategoryValue.equals("Kotlin")){
            ...
            switch (view.getId()){
                ...
                case R.id.Level1:
                    ...
                    intentJavaLevel1.putExtra("Category",TriviaQuestion.CATEGORY_KOTLIN);
                ...
                case R.id.Level2:
                    ...
                    intentJavaLevel2.putExtra("Category",TriviaQuestion.CATEGORY_KOTLIN);
                ...
                case R.id.Level3:
                    ...
                    intentJavaLevel3.putExtra("Category",TriviaQuestion.CATEGORY_KOTLIN);
                ...
                case R.id.Level4:
                    ...
                    intentJavaLevel4.putExtra("Category",TriviaQuestion.CATEGORY_KOTLIN);
                ...
                case R.id.Level5:
                    ...
                    Intent intentJavaLevel5 = new Intent(KoltinLevelsActivity.this,QuizActivity.class);
                    intentJavaLevel5.putExtra("Category",TriviaQuestion.CATEGORY_KOTLIN);
                ...
                case R.id.Level6:
                    ...
                    Intent intentJavaLevel6 = new Intent(KoltinLevelsActivity.this,QuizActivity.class);
                    intentJavaLevel6.putExtra("Category",TriviaQuestion.CATEGORY_KOTLIN);
    ...
    private void lockandUnlockLevels() {
        ...
        JL5 = sharedPreferences.getInt(Constants.KEY_KOTLIN_LEVEL_5,0);
        JL6 = sharedPreferences.getInt(Constants.KEY_KOTLIN_LEVEL_6,0);
